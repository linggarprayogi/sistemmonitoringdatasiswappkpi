 ...
 * @author prayogi
 */
public class laporanabsensi extends javax.swing.JDialog {

    /**
     * Creates new form laporanabsensi
     */
    public laporanabsensi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel13.setText("LAPORAN DATA ABSENSI");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        SimpleDateFormat date;
                ...
                String startdate = date.format(jDateChooser1.getDate());
                String enddate = date.format(jDateChooser2.getDate());
        try {
    ...
    File file = new File("src/sistemmonitoringdatasiswappkpi/laporanabsensi.jrxml");
   ...
   // JasperExportManager.exportReportToPdfFile(jp,"C:/Users/prayogi/Documents/laporandatapeserta.pdf");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                laporanabsensi dialog = new laporanabsensi(new javax.swing.JFrame(), true);
